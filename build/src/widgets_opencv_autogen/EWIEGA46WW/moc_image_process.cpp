/****************************************************************************
** Meta object code from reading C++ file 'image_process.h'
**
...
#error "The header file 'image_process.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 31, 14), // "doWorkFinished"
QT_MOC_LITERAL(5, 46, 12), // "changeSignal"
QT_MOC_LITERAL(6, 59, 6) // "doWork"

    },
    "ImageProcess\0imageReady\0\0image\0"
    "doWorkFinished\0changeSignal\0doWork"
};
...
void ImageProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->doWorkFinished(); break;
        case 2: _t->changeSignal(); break;
        ...
        {
            using _t = void (ImageProcess::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageProcess::imageReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ImageProcess::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageProcess::doWorkFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ImageProcess::imageReady(const QImage & _t1)
{
...
// SIGNAL 1
void ImageProcess::doWorkFinished()
{
